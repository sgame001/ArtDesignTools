...
public class HKOpenFolder : Editor
{
    /// <summary>
    /// 打开 Temporary Cache Path 文件夹。
    /// </summary>
    [MenuItem("HKTools/Open Folder/Temporary Cache Path", false, 10)]
    ...
    /// </summary>
    [MenuItem("HKTools/Open Folder/Persistent Data Path", false, 11)]
    ...
    /// </summary>
    [MenuItem("HKTools/Open Folder/Streaming Assets Path", false, 12)]
    ...
    /// 打开 Data Path 文件夹。
    /// </summary>
    [MenuItem("HKTools/Open Folder/Data Path", false, 13)]
    ...
    private static void InternalOpenFolder(string folder)
    {
        ...
        switch (Application.platform)
        {
            ...
            case RuntimePlatform.OSXEditor:
                ...
                break;
            default:
                throw new NullReferenceException(string.Format("Not support open folder on '{0}' platform.",
