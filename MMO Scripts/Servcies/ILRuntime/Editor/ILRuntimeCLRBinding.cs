...
public class ILRuntimeCLRBinding
{
    ...
    static void GenerateCLRBindingByAnalysis()
    {
        ...
        using (System.IO.FileStream fs = new System.IO.FileStream("Assets/ClientResources/Code/hotfix.dll.bytes", System.IO.FileMode.Open, System.IO.FileAccess.Read))
        {
    ...
    static void InitILRuntime(ILRuntime.Runtime.Enviorment.AppDomain domain)
    {
        ...
        domain.RegisterCrossBindingAdaptor(new GButtonAdaptor());
        domain.RegisterCrossBindingAdaptor(new GComponentAdaptor());
